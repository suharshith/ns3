...
std::string fileNameRoot = "tcpTopology";    // base name for trace files, etc
...
int main (int argc, char *argv[])
{
  ...
  NetDeviceContainer devAR, devRB, devBC;
  PointToPointHelper AR, RB, BC;
  ...
  BC.SetDeviceAttribute ("DataRate", DataRateValue (DataRate (bottleneckBW * 1000 * 1000)));
  ...
  Ipv4Address Caddr = C4->GetAddress(1,0).GetLocal();
  ...
  std::cout << "C's address: " << Caddr << std::endl;
